function [ M_diff_weight ] = M_diff_weight_function_ABA2( num_cells, A, B, A2, n_hold, multi_start, T, sigma_weights)
...
%     x0(1:n_hold) = x0(1:n_hold)>rand();
    ...
    B_new = B.matrix;
    B_new(B_new>0) = B_new(B_new>0).*normrnd(1,sigma_weights,[1,nnz(B_new)])';
