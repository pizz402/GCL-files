function [CorrCellsMatrix, CorrCCCMatrix] = CorrCells_CorrCOC_WeightNoise_MeasureNoise( num_cells, A, B, A2, n_hold_zero, multi_start, T, sigma_weights_vec, sigma_noise_vec, num_itr)
