function [ bcdVec, CMVec ] = MeanCorr_bcR_Exp_new( num_cells, n, D_vec, bcd_itr, std_measurement, num_itr, norm_yesno)
...
%         M = M.*abs(normrnd(1,std_measurement.*M,[num_cells,n]));%%%%%%%%%%%%%%%%%%%%%%change
