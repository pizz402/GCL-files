function [CorrCellsMatrix, CorrCCCMatrix, bcdMatrix, CM ] = CorrCells_CorrCOC_bcd_CM_WeightNoise_SelfActivationNoise( num_cells, A, multi_start, T, sigma_weights_vec, sigma_self_vec, num_itr)
...
%         sigma_weights
        for i = 1:num_itr
            ...
            %uniform noise on weights & self activation
            M = M_NoiseWeightAndSelf_function( num_cells, A, multi_start, T, sigma_weights, sigma_self);
