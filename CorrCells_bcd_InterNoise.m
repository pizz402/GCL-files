function [CorrCellsVec, bcdVec ] = CorrCells_bcd_InterNoise( num_cells, A, B, T, p_vec, num_itr, multi_weight, self_inter_cases)
...
%         i
        ...
        M = M_NoiseInterWeight_function( num_cells, A, B, T, p, multi_weight, self_inter_cases);
