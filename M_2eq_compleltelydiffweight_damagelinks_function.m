function [ M_diff_starts ] = M_2eq_compleltelydiffweight_damagelinks_function( num_cells, percent_damage, A_template, multi_start, T)
...
for i = 1:num_cells
    ...
    [t,z] = ode45(@(t,z) twoeq_mrna_protein(t,z,A_new), [0,T],z0);
